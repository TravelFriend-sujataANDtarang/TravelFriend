package com.example.travelfriend.Constants;
...
public class MyConstants {
    ...
    public static final String BASIC_NEEDS_CAMEL_CASE = "Essentials";

    public static final String CLOTHING_CAMEL_CASE = "Clothing";

    public static final String PERSONAL_CARE_CAMEL_CASE = "Personal Care";

    public static final String BABY_NEEDS_CAMEL_CASE = "Family Needs";
